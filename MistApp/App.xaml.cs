    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<FriendPage>();
        ...
        {
            _host.Start();
            UserService.Instance.CurrentUser = new User { Handle = "Dwell", Name = "Sophie" };
            NavService.Instance.curMainWindow = _host.Services.GetRequiredService<MainWindow>();
        }
